            ...
            <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    <a href="https://flowbite.com" className="flex items-center">
                        <img src="https://raw.githubusercontent.com/social-otter/social-otter/main/social-otter/static/images/otter.png" className="mr-5 h-12 sm:h-12" alt="Flowbite Logo" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Social Otter</span>
                    </a>
